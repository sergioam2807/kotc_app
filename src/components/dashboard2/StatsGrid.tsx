...
const StatsGrid = () => (
  <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
    <div className="bg-[#1e1310] border border-[#2d1d19] p-6 rounded-xl stat-card-glow transition-all text-white">
        <p className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Puntos por partido</p>
    ...
    <div className="bg-[#1e1310] border border-[#2d1d19] p-6 rounded-xl stat-card-glow transition-all text-white">
        <p className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Calificación defensiva</p>
      <div className="flex items-baseline gap-2">
    ...
    <div className="bg-[#1e1310] border border-[#2d1d19] p-6 rounded-xl stat-card-glow transition-all text-white">
        <p className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Ranking global</p>
      <div className="flex items-baseline gap-2">
    ...
    <div className="bg-[#1e1310] border border-[#2d1d19] p-6 rounded-xl stat-card-glow transition-all text-white">
        <p className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-2">Química de equipo</p>
      <div className="flex items-baseline gap-2">
