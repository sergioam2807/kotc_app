          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h5 className="font-bold text-white uppercase italic">Concrete Kings</h5>
                <p className="text-xs chart-1">Brooklyn • Puesto #15</p>
            </div>
          </div>
          <div className="text-right">
            <p className="text-[10px] font-black text-white uppercase">Power</p>
            <p className="text-sm font-black text-white">97.2</p>
          </div>
        </div>
        <div className="grid grid-cols-3 gap-2 mb-4">
          <div className="bg-background-dark p-2 rounded text-center">
              <p className="text-[8px] text-white uppercase font-black">PPP</p>
            <p className="text-xs font-bold text-white">82.1</p>
          </div>
          <div className="bg-background-dark p-2 rounded text-center">
              <p className="text-[8px] text-white uppercase font-black">Racha</p>
            <p className="text-xs font-bold text-white">L2</p>
          </div>
          <div className="bg-background-dark p-2 rounded text-center">
              <p className="text-[8px] text-white uppercase font-black">Estilo</p>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h5 className="font-bold text-white uppercase italic">Harlem Heat</h5>
                <p className="text-xs chart-1">Harlem • Puesto #8</p>
            </div>
          </div>
          <div className="text-right">
            <p className="text-[10px] font-black text-white uppercase">Power</p>
